...
class _$CategoryTearOff {
  ...
  _Category call({String? name, String? image, String? id}) {
    return _Category(
      name: name,
      image: image,
      id: id,
...
class _$_Category implements _Category {
  const _$_Category({this.name, this.image, this.id});
...
abstract class _Category implements Category {
  const factory _Category({String? name, String? image, String? id}) =
      _$_Category;
